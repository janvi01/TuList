        ...
        >
          <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
            ...
            {loading ? null : !user ? (
              <div className="flex">
                <a
                  class="flex items-center gap-x-2 font-medium text-gray-500 cursor-pointer hover:text-blue-600 md:border-s md:border-gray-300 md:my-6 md:ps-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500"
